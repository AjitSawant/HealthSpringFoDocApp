package com.palash.healthspringfoapp.database;
...
import com.palash.healthspringfoapp.entity.Appointment;
...
import com.palash.healthspringfoapp.entity.ELFollowUp;
...
import com.palash.healthspringfoapp.entity.ELSynchOfflineData;
...
import com.palash.healthspringfoapp.entity.PatientQueue;
...
import com.palash.healthspringfoapp.entity.VisitList;
...
public class DatabaseAdapter {
        ...
        private ArrayList<DoctorProfile> CursorToArrayList(Cursor result) {
            ...
            try {
                if (result != null) {
                    ...
                    while (result.moveToNext()) {
                        com.palash.healthspringfoapp.entity.DoctorProfile doctorProfile = new com.palash.healthspringfoapp.entity.DoctorProfile();
    ...
    public class DepartmentAdapter {
        ...
        public ArrayList<Department> listAllDoctorWise(String UnitID, String DoctorID) {
            ArrayList<Department> listDepartment = null;
            Cursor result = null;
            try {
                SQLiteDatabase db = databaseContract.open();
                String whereClause =DatabaseContract.Department.COLUMN_NAME_UnitID + "='" + UnitID + "' AND" +DatabaseContract.Department.COLUMN_NAME_ID + "='" + UnitID + "'";
                result = db.query(DatabaseContract.Department.TABLE_NAME,projection, whereClause,null, null, null,
                        DatabaseContract.Department.DEFAULT_SORT_ORDER);
                listDepartment = CursorToArrayList(result);
            } catch (SQLException e) {
