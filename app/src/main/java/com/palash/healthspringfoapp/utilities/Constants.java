package com.palash.healthspringfoapp.utilities;
...
public class Constants {
    ...
    //localhost Test URL
    public static final String BASE_URL = "http://192.168.1.133/HealthSpringDocApp/";  // local url

    //public static final String BASE_URL = "http://103.229.5.22/HealthSpringDocApp/";  // developer live url
    ...
    public static final String ADD_OTP_URL = BASE_URL + "ForgotPassword/InsertOTP";
    public static final String CHECK_OTP_URL = BASE_URL + "ForgotPassword/CheckOTP";
    public static final String UPDATE_FORGOT_PASSWORD_URL = BASE_URL + "ForgotPassword/UpdatePassword";
