...
import com.palash.healthspringfoapp.adapter.PatientQueueAdapter;
...
import com.palash.healthspringfoapp.entity.ELFilter;
    ...
    private class GetPatientQueueTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (responseCode == Constants.HTTP_OK_200) {
                ...
                patientQueueAdapterDB.delete(doctorProfileList.get(0).getUnitID());
                localSetting.showWarningAlert(context, context.getResources().getString(R.string.opps_alert), "Queue not available for selected unit");
            } else {
