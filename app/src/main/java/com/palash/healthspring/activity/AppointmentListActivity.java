...
public class AppointmentListActivity extends AppCompatActivity {
    ...
    private TextView appointment_list_bnt_search;
    private EditText appointment_edt_fromdate;
    private EditText appointment_edt_todate;
    ...
    private void InitView() {
        try {
            ...
            appointment_list_bnt_search = (TextView) findViewById(R.id.appointment_list_bnt_search);
            appointment_edt_patient_name = (EditText) findViewById(R.id.appointment_edt_patient_name);
            appointment_edt_fromdate = (EditText) findViewById(R.id.appointment_edt_fromdate);
            appointment_edt_todate = (EditText) findViewById(R.id.appointment_edt_todate);
            ...
            appointment_list_bnt_search.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    clearDate();
                }
    ...
    private class GetAppointmentListTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                response = webServiceConsumer.GET(Constants.GET_APPOINTMENT_URL + doctorProfileList.get(0).getDoctorID());
                if (response != null) {
