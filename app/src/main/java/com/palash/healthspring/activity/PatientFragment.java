...
public class PatientFragment extends Fragment implements View.OnClickListener {
    ...
    private void InitView() {
        try {
            search_patient_List = (ListView) parentView.findViewById(R.id.search_patient_List);
            search_patient_empty = (TextView) parentView.findViewById(R.id.search_patient_empty);
            layout_patient_list_search = (LinearLayout) parentView.findViewById(R.id.layout_patient_list_search);
            layout_search_by_patient_name = (LinearLayout) parentView.findViewById(R.id.layout_search_by_patient_name);
            patient_list_edt_search = (EditText) parentView.findViewById(R.id.patient_list_edt_search);
            patient_list_edt_mr_no = (EditText) parentView.findViewById(R.id.patient_list_edt_mr_no);
            patient_list_bnt_clear = (TextView) parentView.findViewById(R.id.patient_list_bnt_clear);
            patient_register_start_date_edt = (TextView) parentView.findViewById(R.id.patient_register_start_date_edt);
            patient_register_end_date_edt = (TextView) parentView.findViewById(R.id.patient_register_end_date_edt);
            patient_report_date_search_btn = (TextView) parentView.findViewById(R.id.patient_report_date_search_btn);
            radio_button_by_date = (RadioButton) parentView.findViewById(R.id.radio_button_by_date);
            radio_button_by_mrno = (RadioButton) parentView.findViewById(R.id.radio_button_by_mrno);
