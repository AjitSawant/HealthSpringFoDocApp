...
*/
    ...
    public void AppointmentReasonTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getAppointmentReasonCount().equals("")) && (!synchronizationList.get(0).getAppointmentReasonCount().equals(String.valueOf(Count)))) {
    ...
    public void SpecializationTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getSpecializationCount().equals("")) && (!synchronizationList.get(0).getSpecializationCount().equals(String.valueOf(Count)))) {
                //Specialization Task
    ...
    public void DoctorTypeTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getDoctorTypeCount().equals("")) && (!synchronizationList.get(0).getDoctorTypeCount().equals(String.valueOf(Count)))) {
                //Doctor type list
    ...
    public void DepartmentTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getDepartmentCount().equals("")) && (!synchronizationList.get(0).getDepartmentCount().equals(String.valueOf(Count)))) {
    ...
    public void ComplaintTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getComplaintCount().equals("")) && (!synchronizationList.get(0).getComplaintCount().equals(String.valueOf(Count)))) {
                //Complaint list task
    ...
    public void MedicienRouteTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getMedicienRouteCount().equals("")) && (!synchronizationList.get(0).getMedicienRouteCount().equals(String.valueOf(Count)))) {
    ...
    public void MedicineFrequencyTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getMedicienFrequencyCount().equals("")) && (!synchronizationList.get(0).getMedicienFrequencyCount().equals(String.valueOf(Count)))) {
    ...
    public void VitalTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getVitalCount().equals("")) && (!synchronizationList.get(0).getVitalCount().equals(String.valueOf(Count)))) {
                //Vital list task
    ...
    public void DaignosisTypeTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getDaignosisTypeCount().equals("")) && (!synchronizationList.get(0).getDaignosisTypeCount().equals(String.valueOf(Count)))) {
    ...
    public void PriorityTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getPriorityCount().equals("")) && (!synchronizationList.get(0).getPriorityCount().equals(String.valueOf(Count)))) {
                //Priority list task
    ...
    public void MedicienInstructionTask() {
        try {
            ...
            if ((!synchronizationList.get(0).getMedicienInstructionCount().equals("")) && (!synchronizationList.get(0).getMedicienInstructionCount().equals(String.valueOf(Count)))) {
